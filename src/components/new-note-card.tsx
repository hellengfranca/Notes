...
export function NewNoteCard({ onNoteCreated }: newNoteCardProps) {
  ...
  function handleStartRecording() {
    ...
    if(!isSpeechRecognitionAPIAvailable) {
      alert('Infelizmente seu navegador não suportaa a API de gravação!')
      return
    }
                ...
                {shouldShowOnboarding ? (
                  ...
                  {isRecording ? (
                    ...
                    <button 
                      ...
                      className='w-full bg-lime-400 py-4 text-center text-sm text-lime-950 outline-none font-medium hover:bg-lime-500 group'>
                      Salvar nota
                    </button>
                  )}
